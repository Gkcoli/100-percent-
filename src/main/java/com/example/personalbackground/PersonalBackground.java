...
public class PersonalBackground extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validateForm()) {
                    ...
                    photo.compress(Bitmap.CompressFormat.JPEG,100,storedPhotoBytes);
                    storedphoto = storedPhotoBytes.toByteArray();
                    submitForm();
                } else {
    ...
    private void submitForm() {
        ...
        intent.putExtra("StoredPhoto",storedphoto);
