...
public class Report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPrefs = getSharedPreferences("myCode", MODE_PRIVATE);

        Intent ooo = getIntent();
        byte[] ddd  = ooo.getByteArrayExtra("DDD");
        Bitmap convert = BitmapFactory.decodeByteArray(ddd,0, ddd.length);
...
//            imgViewPhoto.setImageBitmap(profileImage);
//        }
